<%@ Page Title="" Language="C#" MasterPageFile="~/Layout.master" AutoEventWireup="true" CodeFile="Discusses_Edit.aspx.cs" Inherits="DilasUser_Discusses_Discusses_Edit" %>
...
<h1>編輯塗鴉牆主題</h1>
<uc2:PublishTab ID="PublishTab1" runat="server" tab="1" FunctionName="Discusses"  isCloseFileTab="false" isCloseImageTab="true" isCloseLinkTab="true"   />
...
<td class="datepicker"><asp:TextBox
                ID="initDate" runat="server" Width="250px" CssClass="{validate:{required:true, messages:{required:'張貼日期必填'}}}"></asp:TextBox></td>
</tr>
<tr>
<th >開始日期</th>
<td class="datepicker"><asp:TextBox
                ID="startDate" runat="server" Width="250px" CssClass="{validate:{required:true, messages:{required:'開始日期必填'}}}"></asp:TextBox></td>
</tr>
<tr>
<th>結束日期</th>
<td class="datepicker"><asp:TextBox
                ID="endDate" runat="server" Width="250px" CssClass="{validate:{date:true, messages:{date:'結束日期格式不正確'}}}"></asp:TextBox>(不設定代表永遠生效)</td>
</tr>
<tr>
<th>圖　　片</th>
<td><asp:FileUpload ID="fuPic" runat="server" />
            <asp:HyperLink ID="picUrlLink" runat="server" Target="_blank">檢視圖片</asp:HyperLink></td>
</tr>
<tr>
<th>詳細內容</th>
...
<div class="search_btn">
 <asp:Button ID="InsertButton" runat="server" Text="確定" CssClass="button btn_small" OnClick="InsertButton_Click">
            ...
            <input onclick="location='Discusses_List.aspx?ModuleID=<%=Request["ModuleID"] %>&grade_id=<%=Request["grade_id"] %>&page=<%=string.IsNullOrEmpty(Request["page"])?"1":Request["page"] %>'" type="button"
...
<%--不顯示欄位--%>
         ...
         <div style="display: inherit">
            ...
            <div style="clear:both">
                <asp:TextBox ID="article" runat="server" Width="450px" TextMode="MultiLine"
