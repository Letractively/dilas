...
public partial class DilasUser_Discusses_Discusses_Files : System.Web.UI.Page
{
    ...
    protected void gvList_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            lnkEdit.NavigateUrl =
                String.Format(
                    "_Discusses_Files_Edit.aspx?publishID={0}&ModuleID={1}&ID={2}&KeepThis=true&TB_iframe=true&height=400&width=600",
