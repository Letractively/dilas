<%@ Page Title="" Language="C#" MasterPageFile="~/Layout.master" AutoEventWireup="true" CodeFile="ContactBook_ForParent.aspx.cs" Inherits="DilasUser_ContactBook_ContactBook_ForParent" %>
...
<div class="hb_class"><asp:Label ID="GradeName" runat="server" Text="Label"></asp:Label> <asp:Label ID="StudentName" runat="server" Text="Label"></asp:Label>
 <asp:Label ID="Label1" runat="server" AssociatedControlID="txtDate">日期：</asp:Label><asp:TextBox
            ...
            <asp:Button ID="btnView" runat="server" Text="搜尋" CssClass="btn_small" OnClick="btnView_Click" />
　</div>
...
<table>
<tr>
<td colspan="2">輸入家長密碼：<asp:TextBox ID="Password" runat="server" TextMode="Password"></asp:TextBox></td>
<td></td>
</tr>
<tr>
<td><asp:Panel ID="Panel1" runat="server">

 <asp:TextBox ID="txtArticle" runat="server" Height="120px" TextMode="MultiLine" 
        Width="265px"></asp:TextBox></td>
<td valign="bottom">  <asp:Button ID="Button1" runat="server" onclick="Button1_Click" Text="送出" CssClass="btn_small" />
</td>
</tr>
