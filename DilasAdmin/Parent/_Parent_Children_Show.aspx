<%@ Page Language="C#" AutoEventWireup="true" CodeFile="_Parent_Children_Show.aspx.cs"
    Inherits="DilasAdmin_Parent_Parent_Children_Show" %>
        ...
        <table width="101%" border="1">
            <tr>
                <td width="45%">
                    ...
                    學號:<asp:TextBox ID="txtSearchNumber" runat="server" Width="98px"></asp:TextBox>
                    ...
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="性別">
                                <ItemTemplate>
                                    <asp:Label ID="lblGender" runat="server" Text='<%#  Eval("gender").ToString() %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
            ...
            <tr>
                <td>
                    <div style="overflow-y: scroll">
                        <asp:Label ID="lblMessage" runat="server" Text="請下條件搜尋未指派班級的學生"></asp:Label>
