<%@ Page Language="C#" AutoEventWireup="true" CodeFile="_Grade_Student_Show.aspx.cs"
    Inherits="DilasAdmin_Grade_Grade_Student_Show" %>
                    ...
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="性別">
                                <ItemTemplate>
                                    <asp:Label ID="Label1" runat="server" Text='<%# Eval("gender").ToString() %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
