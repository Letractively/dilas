<%@ Page Title="" Language="C#" MasterPageFile="~/Layout.master" AutoEventWireup="true" CodeFile="_Discusses_Files.aspx.cs" Inherits="DilasUser_Discusses_Discusses_Files" %>
...
<div class="admin_bg">
  ...
  <div class="container">
<uc2:PublishTab ID="PublishTab1" runat="server" tab="2" FunctionName="Discusses" isOpenEditTab="false" isCloseFileTab="false" isCloseImageTab="true" isCloseLinkTab="true" />
  
     
        <p style="margin:10px 0;">
  <a class="a_btn" style="text-decoration:underline" href="<%=String.Format("_News_Files_Insert.aspx?publishID={0}&ModuleID={1}&KeepThis=true&TB_iframe=true&height=400&width=600", Request["ID"], Request["ModuleID"]) %>" title="新增附加檔案" class="thickbox" >新增附加檔案</a>
      

       
        </p>
     <div class="data_table">
<asp:GridView ID="gvList" runat="server" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="id" ForeColor="#333333" onrowdatabound="gvList_RowDataBound" onrowdeleting="gvList_RowDeleting">
        ...
        <input onclick="location='Discusses_List.aspx?ModuleID=<%=Request["ModuleID"] %>&page=<%=string.IsNullOrEmpty(Request["page"])?"1":Request["page"] %>&grade_id=<%=Request["grade_id"] %>'" type="button" value="回列表" class="button btn_small" />
