<%@ Page  ValidateRequest="false"  Title="新增最新動態" Language="C#" MasterPageFile="~/Layout.master" AutoEventWireup="true"
...
<tr>
<th width="14%"> <asp:Label ID="lbltitle" runat="server" AssociatedControlID="title">主題</asp:Label> </th>
<td> <asp:TextBox
                ID="title" runat="server" Width="250px" CssClass="{validate:{required:true, messages:{required:'標題必填'}}}"></asp:TextBox> </td>

</tr>
<tr>
<th width="14%"> <asp:Label ID="lblinitDate" runat="server" AssociatedControlID="initDate">張貼時間</asp:Label> </th>
...
<tr>
<th width="14%"> <asp:Label ID="lblstartDate" runat="server" AssociatedControlID="startDate" CssClass="{validate:{required:true, messages:{required:'開始日期必填'}}}">開始日期</asp:Label> </th>
...
<tr>
<th width="14%">  <asp:Label ID="lblendDate" runat="server" AssociatedControlID="endDate">結束日期</asp:Label></th>
<td class="datepicker">   <asp:TextBox
...
<tr>
<th width="14%"> <asp:Label ID="lblarticle" runat="server" AssociatedControlID="article">詳細內容</asp:Label> </th>
<td> <asp:TextBox ID="article" Height="250px" MaxLength="500" Width="450px" runat="server" CssClass="ckeditor" TextMode="MultiLine"></asp:TextBox> </td>
        ...
        <div class="footer_button">
            ...
            <input onclick="location='News_List.aspx?ModuleID=<%=Request["ModuleID"] %>'" type="button"
                value="回列表" class="button btn_small" /></div>
        <div>
