<%@ Page Title="" Language="C#" MasterPageFile="~/Layout.master" AutoEventWireup="true"
    CodeFile="Parent_View.aspx.cs" Inherits="Parent_View" %>
...
<uc2:PublishTab ID="PublishTab1" runat="server" tab="1" FunctionName="Parent" 
            Fun1TabName="在校子女" Fun1TabURL="Children"  />
...
<tr>
<th> <asp:Label ID="Label1" runat="server" AssociatedControlID="occupation">職　　業</asp:Label>
                </th>
...
<input class="btn_small" type="button" value="回上頁" onclick="location='Parent_List.aspx'" />
