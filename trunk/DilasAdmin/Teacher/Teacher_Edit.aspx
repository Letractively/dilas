<%@ Page Title="" Language="C#" MasterPageFile="~/Layout.master" AutoEventWireup="true"
    CodeFile="Teacher_Edit.aspx.cs" Inherits="Teacher_Edit" %>
...
<h1>教師維護-<asp:Label ID="TeacherName" runat="server" Text="Label"></asp:Label></h1>
 <uc2:PublishTab ID="PublishTab1" runat="server" tab="2" FunctionName="Teacher" isOpenEditTab="True" />
...
<tr>
<th> <asp:Label ID="Label2" runat="server" AssociatedControlID="ddlSchool">學校名稱</asp:Label></th>
<td>   <asp:DropDownList ID="ddlSchool" runat="server" Enabled="False">
                </asp:DropDownList></td>
</tr>
<tr>
