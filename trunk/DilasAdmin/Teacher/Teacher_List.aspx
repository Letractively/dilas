<%@ Page Title="" Language="C#" MasterPageFile="~/Layout.master" AutoEventWireup="true"
    CodeFile="Teacher_List.aspx.cs" Inherits="Teacher_List" %>
...
<div class="admin_bg">
 ...
 <input type="button" onclick="location='Teacher_Insert.aspx'" value="新增老師" runat="server" id="btnAdd" Visible="false" class="btn_small" />
 </div>
  <div class="search">
  ...
  <tr>
    ...
    <th>等級</th>
    <td><asp:DropDownList ID="ddlRank" runat="server"><asp:ListItem Value="-1">請選擇</asp:ListItem><asp:ListItem Value="0">正式</asp:ListItem><asp:ListItem Value="1">代課</asp:ListItem></asp:DropDownList></td>
  </tr>
  <tr>
    <th>性別</th>
    <td><asp:DropDownList ID="ddlGender" runat="server"><asp:ListItem Value="-1">請選擇</asp:ListItem><asp:ListItem Value="False">男</asp:ListItem><asp:ListItem Value="True">女</asp:ListItem></asp:DropDownList></td>
    <th><asp:Label ID="lblSchool" runat="server" Text="學校"></asp:Label></th>
  ...
  <div class="data_table">
    <asp:GridView ID="gvList" runat="server" AutoGenerateColumns="False" DataKeyNames="id"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="name" HeaderText="老師姓名" SortExpression="name">
